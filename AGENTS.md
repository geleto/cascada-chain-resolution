...
Export follows the common operation-work lifetime. Closing releases partial output state. A reached Error discards output copies but does not close the operation until its required Error scan finishes.
