...
Receiver preparation and argument export share one operation-work lifetime. A terminal failure in either closes operation-specific work in both; later continuations complete shared mirror and property-version settlement but perform no further traversal, reflection, copying, or lease acquisition.
